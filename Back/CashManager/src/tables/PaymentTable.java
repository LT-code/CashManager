	...
	private final static Table table = 
			new Table(	"Payment",
				...
				new TableFields[]	{	
					...
					new TableFields("idCart",		TableFields.TYPE_INT, 		11,	TableFields.KEY_FOREIGN_ON_DELETE_CASCADE, CartTable.getTable().getName() + "Cart(idCart)"),
					new TableFields("idType", 		TableFields.TYPE_INT,		11, TableFields.KEY_FOREIGN, PaymentTypeTable.getTable().getName() + "PaymentType(idType)"),
